...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<h3 class="text-center"><strong>Are You Sure You Want To Want To Delete Item With These Details?</strong></h3>
				...
				<div class="col-md-6">
					...
					<form method="post" action="includes/server_scripts/deleteItem.php" enctype="multipart/form-data">
						<input type="hidden" name="itemId" value="<?php echo $itemId; ?>">

						<button type="submit" class="btn btn-custom-2"><i class="fa fa-check"></i> Yes, Delete</button>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="main.php"><button class="btn btn-custom-2"><i class="fa fa-arrow-left"></i> No, Go Back</button></a>
					</form>
